        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-header">
                ...
                <form method="post" action="">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <label> {{ __('messages.cat_permissions') }} </label>
                        </div>
                        @foreach($data['categories'] as $row)
                            <div class="col-md-3">
                                <div>
                                    <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                                        <input name="selected_cats[]" value="{{$row->id}}" type="checkbox" class="new-control-input">
                                        <span class="new-control-indicator"></span><span
                                            class="new-chk-content">{{ app()->getLocale() == 'en' ? $row->title_en : $row->title_ar }}</span>
                                    </label>
                                </div>
                            </div>
                        @endforeach
